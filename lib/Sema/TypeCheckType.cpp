      ...
      if (!attrs.hasConvention()) {
        ...
        auto parsedRep =
            llvm::StringSwitch<Optional<SILFunctionType::Representation>>(
                ...
                .Case("keypath_accessor_getter", SILFunctionType::Representation::KeyPathAccessorGetter)
                .Case("keypath_accessor_setter", SILFunctionType::Representation::KeyPathAccessorSetter)
                .Case("keypath_accessor_equals", SILFunctionType::Representation::KeyPathAccessorEquals)
                .Case("keypath_accessor_hash", SILFunctionType::Representation::KeyPathAccessorHash)
                .Default(None);
        if (!parsedRep) {
