//===--- BareMetalToolChains.cpp - Job invocations (bare metal triples) ---===//
//
...
std::string
toolchains::BareMetal::sanitizerRuntimeLibName(StringRef Sanitizer,
                                                 bool shared) const {
...
toolchains::BareMetal::constructInvocation(const InterpretJobAction &job,
...
ToolChain::InvocationInfo toolchains::BareMetal::constructInvocation(
...
std::string toolchains::BareMetal::getDefaultLinker() const {
...
bool toolchains::BareMetal::addRuntimeRPath(const llvm::Triple &T,
...
ToolChain::InvocationInfo
toolchains::BareMetal::constructInvocation(const DynamicLinkJobAction &job,
                                             const JobContext &context) const {
...
ToolChain::InvocationInfo
toolchains::BareMetal::constructInvocation(const StaticLinkJobAction &job,
                               const JobContext &context) const {
   assert(context.Output.getPrimaryOutputType() == file_types::TY_Image &&
         "Invalid linker output type.");
