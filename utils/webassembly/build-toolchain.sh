...
MONTH=$(date +"%m")
DAY=$(date +"%d")
TOOLCHAIN_NAME="swift-wasm-5.5-SNAPSHOT-${YEAR}-${MONTH}-${DAY}-a"

PACKAGE_ARTIFACT="$SOURCE_PATH/swift-wasm-5.5-SNAPSHOT-${OS_SUFFIX}.tar.gz"
...
create_darwin_info_plist() {
  ...
  DARWIN_TOOLCHAIN_DISPLAY_NAME_SHORT="Swift for WebAssembly 5.5 Snapshot"
